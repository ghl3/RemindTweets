...
create unique index "UNIQUE_REMINDER_TWEETID" on "reminders" ("tweet_id");
...
alter table "reminders" add constraint "REMINDER_TWEET_FK" foreign key("tweet_id") references "tweets"("id") on update NO ACTION on delete NO ACTION;
