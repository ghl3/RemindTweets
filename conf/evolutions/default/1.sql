...
create table "scheduledreminders" ("id" SERIAL NOT NULL PRIMARY KEY,"reminderid" BIGINT NOT NULL,"time" timestamp NOT NULL,"executed" BOOLEAN NOT NULL,"cancelled" BOOLEAN NOT NULL);
create table "tweets" ("id" SERIAL NOT NULL PRIMARY KEY,"twitterid" BIGINT NOT NULL,"content" json NOT NULL,"fetchedat" timestamp NOT NULL);
